    ...
    <div className="relative aspect-[3/2] lg:aspect-[25/9] bg-black">
      ...
      <div className="absolute inset-0 px-24 flex flex-col justify-center lg:px-25 lg:w-2/3 lg:bg-gradient-to-r shadow-gradient">
        <div className="text-white animate-slide-up">
          ...
          <p className="mt-2 opacity-80 leading-relaxed line-clamp-3 md:line-clamp-5 text-xs md:text-base">
            {infoFilm?.movie?.content}
          </p>
          <div className="py-2 hidden lg:block">
            <button
              type="button"
              onClick={handleWatchDetail}
              className="flex gap-2 items-center px-6 py-2 bg-transparent hover:bg-gray-300 text-white hover:text-black transition rounded border-none"
              title="Xem Trailer"
            >
              <PlayCircleOutlined className="text-xl mb-[6px]" /> Xem ngay
            </button>
          </div>
        </div>
      </div>
