...
const MovieDetail = ({ infoFilm }: MovieDetailProps) => {
  ...
  return (
    <div className="flex flex-col md:px-4">
      ...
      <div className="container mx-auto max-w-[1200px] px-4 md:px-0 pb-10">
        <div className="flex flex-col lg:flex-row w-full">
          ...
          <div className="w-full lg:w-[72%] lg:pl-12 lg:py-2 text-white">
            <div>
              <h2 className="text-[20px] lg:text-[30px] leading-7 lg:leading-9">Cốt truyện</h2>
              <p className="opacity-80 leading-[1.5rem] lg:leading-[1.65rem]">{infoFilm?.movie?.content}</p>
            </div>
            ...
            {selectedTab === 'overview' && (
              <div className="mt-8 text-white">
                <h2 className="text-[20px] lg:text-[30px] leading-7 lg:leading-9">Danh sách tập phim</h2>
